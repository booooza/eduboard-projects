...
int main(void)
{
	...
	PORTE_DIR = 0b00001110; // Set PORTE3 as Output (LED 5)
	...
	*/
	TCE0_CTRLB = TC0_CCBEN_bm | TC0_CCCEN_bm | TC0_CCDEN_bm| TC_WGMODE_FRQ_gc;
	TCE0_CCA = 50000; 	// TC0 (TCE0) - 16-bit Timer/Counter 0
